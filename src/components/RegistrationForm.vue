<template>
  <div class="form-signin">
    <Form @submit="registrateUser" :validation-schema="schema">
      ...
      <div class="form-floating">
        <Field v-model="new_user.email" name="email" id="email" type="email" class="form-control" placeholder="email" />
        <label for="email">email</label>
        <ErrorMessage as="div" name="email" class="alert alert-danger p-1" />
      </div>
      <div class="form-floating">
        <Field v-model="new_user.phone" name="tel" id="tel" type="text" class="form-control" placeholder="Телефон" />
        <label for="tel">Телефон</label>
        <ErrorMessage as="div" name="tel" class="alert alert-danger p-1" />
      </div>
      <div class="form-floating">
        <Field v-model="new_user.contacts" name="contacts" id="contacts" type="text" class="form-control"
          placeholder="Контакты" />
        <label for="contacts">Контакты</label>
        <ErrorMessage as="div" name="contacts" class="alert alert-danger p-1" />
      </div>
      <div class="form-floating">
        <Field v-model="new_user.password" name="password" id="password" type="password" class="form-control"
          placeholder="Пароль" />
        <label for="password">Пароль</label>
        <ErrorMessage as="div" name="password" class="alert alert-danger p-1" />
      </div>
      <div class="form-floating">
        <Field v-model="new_user.password_repeat" name="passwordRepeat" id="passwordRepeat" type="password"
